...
/**
 * <p>Original spec-file module name: eapearson_TestRichReports</p>
 * <pre>
 * A KBase module: eapearson_TestRichReports
 * This sample module contains one small method - filter_contigs.
 * </pre>
 */
public class EapearsonTestRichReportsClient {
     ...
     */
    public EapearsonTestRichReportsClient(URL url) {
     ...
     * validity.
     */
    public EapearsonTestRichReportsClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public EapearsonTestRichReportsClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public EapearsonTestRichReportsClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("eapearson_TestRichReports.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
