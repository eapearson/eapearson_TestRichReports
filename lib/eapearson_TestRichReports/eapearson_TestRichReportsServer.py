...
import os
from eapearson_TestRichReports.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'eapearson_TestRichReports'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from eapearson_TestRichReports.eapearson_TestRichReportsImpl import eapearson_TestRichReports  # noqa @IgnorePep8
impl_eapearson_TestRichReports = eapearson_TestRichReports(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'eapearson_TestRichReports'
