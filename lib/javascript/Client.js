...
function eapearson_TestRichReports(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.generate_report = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "eapearson_TestRichReports.generate_report",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "eapearson_TestRichReports.status",
